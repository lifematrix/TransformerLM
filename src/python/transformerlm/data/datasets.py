# Originally sourced from <https://github.com/ml-explore/mlx-examples/blob/main/transformer_lm/datasets.py>
#
...
class TinyDataset:
    @classmethod
    def load_dataset(cls, dataname):
        if dataname == "ptb":
            return cls.ptb()
        elif dataname == "wikitext2":
            return cls.wikitext(dataset="2")
        else:
            return cls.wikitext(dataset="103")


    @classmethod
    def _load(cls, save_dir, filenames):
    ...
    @classmethod
    def wikitext(cls, dataset="2", save_dir="/tmp"):
        """
        ...
        return cls._load(data_dir, filenames)


    @classmethod
    def ptb(cls, save_dir="/tmp"):
        """
        ...
        return cls._load(save_dir, filenames)
